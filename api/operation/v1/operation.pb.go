...
const file_operation_v1_operation_proto_rawDesc = "" +
	"\n" +
	"\x1coperation/v1/operation.proto\x12\x10api.operation.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17validate/validate.proto\"\xd6\x01\n" +
