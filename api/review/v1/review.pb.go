...
const file_review_v1_review_proto_rawDesc = "" +
	"\n" +
	"\x16review/v1/review.proto\x12\rapi.review.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17validate/validate.proto\"\x90\x03\n" +
	...
	"\bstore_id\x18\x03 \x01(\x03B\a\xfaB\x04\"\x02 \x00R\astoreId\x12%\n" +
	"\x05score\x18\x04 \x01(\x05B\x0f\xfaB\f\x1a\n" +
	"0\x010\x020\x030\x040\x05R\x05score\x124\n" +
	"\rservice_score\x18\x05 \x01(\x05B\x0f\xfaB\f\x1a\n" +
	"0\x010\x020\x030\x040\x05R\fserviceScore\x124\n" +
	"\rexpress_score\x18\x06 \x01(\x05B\x0f\xfaB\f\x1a\n" +
	...
	"\n" +
	"video_info\x18\t \x01(\tR\tvideoInfo\x12\x1c\n" +
	"\tanonymous\x18\n" +
	" \x01(\bR\tanonymous\"0\n" +
	...
	"\tappeal_id\x18\x01 \x01(\x03R\bappealId\"\xd6\x01\n" +
