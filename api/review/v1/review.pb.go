...
// 字段最好还是按照规范来，用snake_case
type CreateReviewRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        int64                  `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	OrderId       int64                  `protobuf:"varint,2,opt,name=order_id,json=orderId,proto3" json:"order_id,omitempty"`                // 跟上面一样，写法不同
	Score         int32                  `protobuf:"varint,3,opt,name=score,proto3" json:"score,omitempty"`                                   // 商品打分
	ServiceScore  int32                  `protobuf:"varint,4,opt,name=service_score,json=serviceScore,proto3" json:"service_score,omitempty"` // 服务打分
	ExpressScore  int32                  `protobuf:"varint,5,opt,name=express_score,json=expressScore,proto3" json:"express_score,omitempty"` // 物流打分
	Content       string                 `protobuf:"bytes,6,opt,name=content,proto3" json:"content,omitempty"`                                // 评价内容
	PictureInfo   string                 `protobuf:"bytes,7,opt,name=picture_info,json=pictureInfo,proto3" json:"picture_info,omitempty"`
	VideoInfo     string                 `protobuf:"bytes,8,opt,name=video_info,json=videoInfo,proto3" json:"video_info,omitempty"`
	Anonymous     bool                   `protobuf:"varint,9,opt,name=anonymous,proto3" json:"anonymous,omitempty"` // 是否是匿名
...
func (x *CreateReviewRequest) GetPictureInfo() string {
	if x != nil {
...
type CreateReviewReply struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ReviewId      int64                  `protobuf:"varint,1,opt,name=review_id,json=reviewId,proto3" json:"review_id,omitempty"` // 评价id
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type AuditAppealRequest struct {
	...
	Status        int32                  `protobuf:"varint,2,opt,name=status,proto3" json:"status,omitempty"`
	OpUser        string                 `protobuf:"bytes,3,opt,name=op_user,json=opUser,proto3" json:"op_user,omitempty"`
	OpRemarks     *string                `protobuf:"bytes,4,opt,name=op_remarks,json=opRemarks,proto3,oneof" json:"op_remarks,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_api_review_v1_review_proto_rawDesc = "" +
	"\n" +
	"\x1aapi/review/v1/review.proto\x12\rapi.review.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17validate/validate.proto\"\xf4\x02\n" +
	...
	"\xfaB\ar\x05\x10\b\x18\xff\x01R\acontent\x12!\n" +
	"\fpicture_info\x18\a \x01(\tR\vpictureInfo\x12\x1d\n" +
	"\n" +
	...
	"\x04data\x18\x01 \x01(\v2\x19.api.review.v1.ReviewInfoR\x04data\"\xa9\x02\n" +
	"\n" +
	"ReviewInfo\x12\x1b\n" +
	...
	"\tappeal_id\x18\x01 \x01(\x03R\bappealId\"\xb0\x01\n" +
	"\x12AuditAppealRequest\x12$\n" +
	"\tappeal_id\x18\x01 \x01(\x03B\a\xfaB\x04\"\x02 \x00R\bappealId\x12\x1f\n" +
	"\x06status\x18\x02 \x01(\x05B\a\xfaB\x04\x1a\x02 \x00R\x06status\x12 \n" +
	"\aop_user\x18\x03 \x01(\tB\a\xfaB\x04r\x02\x10\x02R\x06opUser\x12\"\n" +
	"\n" +
	"op_remarks\x18\x04 \x01(\tH\x00R\topRemarks\x88\x01\x01B\r\n" +
	"\v_op_remarks\"/\n" +
	"\x10AuditAppealReply\x12\x1b\n" +
	"\tappeal_id\x18\x01 \x01(\x03R\bappealId\"=\n" +
	"\x19ListReviewByUserIDRequest\x12 \n" +
	"\auser_id\x18\x01 \x01(\x03B\a\xfaB\x04\"\x02 \x00R\x06userId\"H\n" +
	"\x17ListReviewByUserIDReply\x12-\n" +
	"\x04list\x18\x01 \x03(\v2\x19.api.review.v1.ReviewInfoR\x04list2\xae\x06\n" +
	"\x06Review\x12k\n" +
	...
	"\vAuditAppeal\x12!.api.review.v1.AuditAppealRequest\x1a\x1f.api.review.v1.AuditAppealReply\"\x1b\x82\xd3\xe4\x93\x02\x15:\x01*\"\x10/v1/appeal/audit\x12\x85\x01\n" +
	"\x12ListReviewByUserID\x12(.api.review.v1.ListReviewByUserIDRequest\x1a&.api.review.v1.ListReviewByUserIDReply\"\x1d\x82\xd3\xe4\x93\x02\x17\x12\x15/v1/{user_id}/reviewsB2\n" +
