...
// 项目错误码定义，可以参考kratos官方文档 https://go-kratos.dev/docs/component/errors
// 在这里定义完，也要去makefile中添加命令，直接参考官方文档即可(但是自己需要参考其他make命令，写一下.PHONY这些)
...
const (
	...
	ErrorReason_ORDER_REVIEWED                  ErrorReason = 100 // 订单已经评价过
	ErrorReason_REVIEW_REPLYED                  ErrorReason = 101 // 评价已经被（商家）回复过
	ErrorReason_CANNOT_REPLY_OHTER_STORE_REVIEW ErrorReason = 102 // 商家不能回复另一个商家的评论
)
...
var (
	ErrorReason_name = map[int32]string{
		...
		100: "ORDER_REVIEWED",
		101: "REVIEW_REPLYED",
		102: "CANNOT_REPLY_OHTER_STORE_REVIEW",
	}
	ErrorReason_value = map[string]int32{
		...
		"ORDER_REVIEWED":                  100,
		"REVIEW_REPLYED":                  101,
		"CANNOT_REPLY_OHTER_STORE_REVIEW": 102,
	}
)
...
const file_api_review_v1_review_error_proto_rawDesc = "" +
	"\n" +
	" api/review/v1/review_error.proto\x12\rapi.review.v1\x1a\x13errors/errors.proto*\x9d\x01\n" +
	...
	"\x0eREVIEW_REPLYED\x10e\x1a\x04\xa8E\x90\x03\x12)\n" +
	"\x1fCANNOT_REPLY_OHTER_STORE_REVIEW\x10f\x1a\x04\xa8E\x90\x03\x1a\x04\xa0E\xf4\x03B2\n" +
